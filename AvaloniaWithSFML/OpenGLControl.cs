...
namespace AvaloniaWithSFML
{
    ...
    {
        public static readonly DirectProperty<OpenGLControl, BaseGame?> WindowProperty =
        AvaloniaProperty.RegisterDirect<OpenGLControl, BaseGame?>(
            nameof(BaseGame),
            o => o.Window,
            (o, v) => o.Window = v);
...
void main()
{
    ...
    outputColor = texColor;
        ...
        protected override void OnSizeChanged(SizeChangedEventArgs e)
        {
            ...
            {
                //_window.RenderWindow.Size = new SFML.System.Vector2u((uint)e.NewSize.Width, (uint)e.NewSize.Height);
                //_window.GeneralRender = new RenderTexture((uint)e.NewSize.Width, (uint)e.NewSize.Height);
                //_window.GeneralRender.Smooth = false;
                //_window.GeneralRender.Clear(SFML.Graphics.Color.Blue);
                //_window.GeneralRender.Display();
